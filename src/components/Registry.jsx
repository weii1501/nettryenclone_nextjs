...
export default function Login() {
  return (
    <>
        ...
        />
        <label htmlFor="" className="font-extralight text-[14px] text-[#333333]">Tài khoản</label>
        <input 
            type="text" 
        ...
        <input 
            ...
            className="w-full h-[36px] outline-0 border-black-rgba-border border-[1px] rounded px-3 mt-2 mb-4"
        />
        <label htmlFor="" className="font-extralight text-[14px] text-[#333333]">Nhập lại mật khẩu</label>
        <input 
            type="password" 
            placeholder="Your password" 
            required
            className="w-full h-[36px] outline-0 border-black-rgba-border border-[1px] rounded px-3 mt-2 mb-4"
        />
        <a href="#" className="w-full h-auto text-right text-[13px] text-[#288ad6] hover:text-purple-700 hover:underline mb-2">Quên mật khẩu</a>
        ...
        <button className="w-full h-auto bg-[#3a5998] text-[14px] mt-3 py-3 rounded text-white flex flex-row justify-start items-center">
            ...
            <span className="w-full text-center">Đăng ký bằng Facebook</span>
        </button>
        <button className="w-full h-auto bg-[#dd4b39] text-[14px] mt-3 py-3 rounded text-white flex flex-row justify-start items-center">
            ...
            <span className="w-full text-center">Đăng ký bằng Google</span>
        </button>
    </>
  )
}
